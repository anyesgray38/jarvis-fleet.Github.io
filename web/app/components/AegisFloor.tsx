...
type KnowledgeSnapshot = {
  ...
  departments?: { id: string; name: string; manager: string; packets: number; status: string; configured_topics?: number; configured_queries?: number; configured_urls?: number; research_inputs?: { topics: string[]; queries: string[]; urls: string[] }; last_error_count: number }[]
  research?: { due_departments: string[]; cycles: { cycle_id: string; completed_at: string; jobs: number; packets: number; external_calls?: number; errors: string[] }[] }
  error: string | null
}
